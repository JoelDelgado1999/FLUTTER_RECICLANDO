...
import 'package:flutter_recolectando_innomine/src/pages/client/profile/info/client_profile_info_controller.dart';
  ...
  Widget _boxForm(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: <BoxShadow>[
            BoxShadow(
                color: Colors.black54, blurRadius: 25, offset: Offset(0, 0.75))
          ]),
