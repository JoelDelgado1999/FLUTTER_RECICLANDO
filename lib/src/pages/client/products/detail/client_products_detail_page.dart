...
import 'package:flutter_recolectando_innomine/src/pages/client/products/detail/client_products_detail_controller.dart';
...
class ClientProductsDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: Container(
          color: Colors.amber, height: 100, child: _buttonsAddToBag()),
      body: Column(
        children: [
  ...
  Widget _buttonsAddToBag() {
    return Column(
      children: [
        ...
        Container(
          margin: EdgeInsets.only(left: 120, right: 50, top: 25),
          child: Row(
            children: [
              ElevatedButton(
                onPressed: () {},
  ...
  Widget _textPriceProduct() {
    return Container(
      ...
      child: Text(
        '\Puntos necesarios : ${product?.price.toString() ?? ''}',
        style: TextStyle(
